...
class TestSudokoSolver(unittest.TestCase):
    ...
    def test_onlychoice(self):
        ...
        expected = {'A1': '4', 'A2': '8', 'A3': '3', 'A4': '9', 'A5': '2', 'A6': '1', 'A7': '6', 'A8': '5789', 'A9': '5', 'B1': '9', 'B2': '6', 'B3': '47', 'B4': '3', 'B5': '4', 'B6': '5', 'B7': '8', 'B8': '8', 'B9': '1', 'C1': '2', 'C2': '257', 'C3': '1', 'C4': '8', 'C5': '7', 'C6': '6', 'C7': '4', 'C8': '23579', 'C9': '2357', 'D1': '345', 'D2': '345', 'D3': '8', 'D4': '1', 'D5': '3456', 'D6': '2', 'D7': '9', 'D8': '34567', 'D9': '34567', 'E1': '7', 'E2': '2', 'E3': '9', 'E4': '5', 'E5': '3', 'E6': '4', 'E7': '1', 'E8': '13456', 'E9': '8', 'F1': '1345', 'F2': '13459', 'F3': '6', 'F4': '7', 'F5': '3459', 'F6': '8', 'F7': '2', 'F8': '1345', 'F9': '345', 'G1': '134', 'G2': '1347', 'G3': '2', 'G4': '6', 'G5': '8', 'G6': '9', 'G7': '5', 'G8': '1478', 'G9': '47', 'H1': '8', 'H2': '1', 'H3': '47', 'H4': '2', 'H5': '5', 'H6': '3', 'H7': '17', 'H8': '6', 'H9': '9', 'I1': '6', 'I2': '9', 'I3': '5', 'I4': '4', 'I5': '1', 'I6': '7', 'I7': '3', 'I8': '8', 'I9': '2'}
    ...
    def test_reduce_puzzle(self):
        ...
        solution.reduce_puzzle(puzzle)
        expexted = {'A1': '4', 'A2': '8', 'A3': '3', 'A4': '9', 'A5': '2', 'A6': '1', 'A7': '6', 'A8': '7', 'A9': '5', 'B1': '9', 'B2': '6', 'B3': '7', 'B4': '3', 'B5': '4', 'B6': '5', 'B7': '8', 'B8': '', 'B9': '1', 'C1': '2', 'C2': '5', 'C3': '1', 'C4': '8', 'C5': '7', 'C6': '6', 'C7': '4', 'C8': '9', 'C9': '3', 'D1': '345', 'D2': '345', 'D3': '8', 'D4': '', 'D5': '6', 'D6': '2', 'D7': '9', 'D8': '7', 'D9': '6', 'E1': '7', 'E2': '2', 'E3': '9', 'E4': '5', 'E5': '3', 'E6': '4', 'E7': '1', 'E8': '6', 'E9': '8', 'F1': '1345', 'F2': '1345', 'F3': '6', 'F4': '7', 'F5': '9', 'F6': '8', 'F7': '2', 'F8': '345', 'F9': '345', 'G1': '3', 'G2': '7', 'G3': '', 'G4': '6', 'G5': '8', 'G6': '9', 'G7': '5', 'G8': '1', 'G9': '7', 'H1': '8', 'H2': '1', 'H3': '4', 'H4': '2', 'H5': '5', 'H6': '3', 'H7': '7', 'H8': '', 'H9': '9', 'I1': '6', 'I2': '9', 'I3': '5', 'I4': '4', 'I5': '1', 'I6': '7', 'I7': '3', 'I8': '8', 'I9': '2'}
        self.assertEqual(expexted, puzzle)

    def test_search(self):
        p = '4.....8.5.3..........7......2.....6.....8.4......1.......6.3.7.5..2.....1.4......'
        p = solution.grid_values(p)
        solution.search(p)
        expected = {'A1': '4', 'A2': '9', 'A3': '7', 'A4': '1', 'A5': '2', 'A6': '6', 'A7': '8', 'A8': '3', 'A9': '5', 'B1': '6', 'B2': '3', 'B3': '8', 'B4': '4', 'B5': '6', 'B6': '568', 'B7': '79', 'B8': '2', 'B9': '179', 'C1': '289', 'C2': '1', 'C3': '2', 'C4': '7', 'C5': '3', 'C6': '58', 'C7': '6', 'C8': '4', 'C9': '139', 'D1': '8', 'D2': '2', 'D3': '1', 'D4': '5', 'D5': '39', 'D6': '4', 'D7': '379', 'D8': '6', 'D9': '379', 'E1': '7', 'E2': '5', 'E3': '569', 'E4': '39', 'E5': '8', 'E6': '2', 'E7': '4', 'E8': '1', 'E9': '379', 'F1': '3', 'F2': '4', 'F3': '569', 'F4': '', 'F5': '1', 'F6': '7', 'F7': '5', 'F8': '8', 'F9': '239', 'G1': '2', 'G2': '8', 'G3': '9', 'G4': '6', 'G5': '5', 'G6': '3', 'G7': '1', 'G8': '7', 'G9': '4', 'H1': '5', 'H2': '7', 'H3': '3', 'H4': '2', 'H5': '4', 'H6': '1', 'H7': '', 'H8': '9', 'H9': '8', 'I1': '1', 'I2': '6', 'I3': '4', 'I4': '8', 'I5': '7', 'I6': '9', 'I7': '3', 'I8': '5', 'I9': '2'}
        
        self.assertEqual(expected, p)

    def test_naked_twins_submit(self):
        puzzle = {"G7": "2345678", "G6": "1236789", "G5": "23456789", "G4": "345678",
